...
public:
        ...
        ignition::math::Vector3d _angularVel, double _maxForce, double _maxTorque)
    {
        ...
        //physics::PhysicsEnginePtr engine = world->SetPhysicsEnabled();
        ...
        ignition::math::Pose3d revoluteJointOrigin;
        this->revoluteJoint->Load(this->phantomLink, _link,
            revoluteJointOrigin);
        this->revoluteJoint->Init();
        double angularMagnitude = _angularVel.Length();
...
private:
    physics::JointPtr revoluteJoint;

private:
    physics::LinkPtr phantomLink;
};
}  // namespace gazebo
#endif
