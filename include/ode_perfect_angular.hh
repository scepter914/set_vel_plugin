...
{
public:
    OdePerfectAngularVelController()
    {
    }
...
public:
    void Start(
        physics::LinkPtr _link, ignition::math::Vector3d _vel, double _maxTorque)
    {
        this->Stop();
        ...
        physics::LinkPtr worldLink = boost::dynamic_pointer_cast<physics::Link>(world->BaseByName("world"));
